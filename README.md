...
|---|---|---|---|---|
| [Lost Lands](packs/lost-lands/2026/festpack.json) | 2026 | ✅ partial (headliners by day) | ✅ full (222/222 sets) | ✅ stylized (Crater, Prehistoric, Wompy Woods pinned on imagery; other stages approx. points from imagery + the official 2026 map's layout; venue extent, treeline unverified; campgrounds unplaced) |
